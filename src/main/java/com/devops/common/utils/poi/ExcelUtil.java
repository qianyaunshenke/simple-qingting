package com.devops.common.utils.poi;
...
import com.devops.common.utils.file.FileTypeUtils;
import com.devops.common.utils.file.ImageUtils;
import com.devops.common.utils.reflect.ReflectUtils;
import com.devops.common.utils.text.Convert;
import com.devops.framework.aspectj.lang.annotation.Excel;
import com.devops.framework.aspectj.lang.annotation.Excels;
import com.devops.framework.config.GlobalConfig;
import com.devops.framework.web.domain.AjaxResult;
import com.devops.project.system.utils.DictUtils;
...
//    public static final int sheetSize = 65536;
     ...
     * @return 结果
     */
    public AjaxResult exportExcel(List<T> list, List<String> dynamicColumns,String sheetName)
    {
        this.dynamicColumns= Optional.ofNullable(dynamicColumns).orElse(new ArrayList<String>());
        this.init(list, sheetName, Excel.Type.EXPORT);
        return exportExcel();
    }
     ...
     * @return 结果
     */
    public AjaxResult exportExcel(Workbook workbook,String sheetName)
    {
        OutputStream out = null;
        try
        {
    ...
    private void putToField(Field field, Excel attr)
    {
        if (attr != null && (attr.type() == Excel.Type.ALL || attr.type() == type))
        {
            if(attr.isDynamic() && !this.dynamicColumns.contains(field.getName())){
                //如果是动态列，但是导出方法入口 dynamicColumns对象中没有包含该列字段名，则不导出本列
                return;
            }
