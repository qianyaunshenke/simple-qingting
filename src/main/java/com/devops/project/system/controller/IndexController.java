...
import com.devops.common.utils.CookieUtils;
...
import com.devops.project.system.domain.Menu;
...
public class IndexController extends BaseController
{
    ...
    public String index(ModelMap mmap)
    {
        ...
        //调用go 获取token
        String goToken = qingtingQiaoService.getToken(user.getUserId());
        mmap.put("goToken", goToken);
        // 根据用户id取出菜单
